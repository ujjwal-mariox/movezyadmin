...
const VehicleManagement = () => {
  ...
  const filteredVehicles = vehicles.filter((vehicle) => {
    const matchesType = filterType === "All Vehicle Types" || vehicle.type === filterType;
      ...
      <div className="bg-white rounded-xl shadow overflow-hidden">
        <table className="w-full text-left border-collapse">
          <thead className="bg-gray-50 border-b border-gray-100">
            <tr>
              <th className="px-6 py-4 text-sm font-semibold text-gray-600">Vehicle No</th>
          ...
          <tbody className="divide-y divide-gray-100">
            {filteredVehicles.map((vehicle) => (
              <tr key={vehicle.id} className="hover:bg-gray-50 transition-colors">
                <td className="px-6 py-4 text-sm font-medium text-gray-900">{vehicle.vehicleNo}</td>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setCurrentVehicle({ ...currentVehicle, vehicleNo: e.target.value })}
